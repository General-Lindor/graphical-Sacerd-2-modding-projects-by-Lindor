## <a name="first"></a>$${\underline{\textbf{\color{teal}Dokumentation \space meiner \space graphischen \space Projekte \space im \space Bereich \space Modding \space Sacred \space 2}}}$$
