  ...
  uniform float4    light_col_diff)
{
  ...
  sum_num = 2;
	...
	for(i = 0; i < sum_num; i++)
	{
	  ...
	  // fx base color
	  s2half4 base_color = tex2D(texture2, newUV);
...
/*  
  ...
  */
	...
	// standard lighting
	s2half4 tex2 = tex2D(texture0, I.texcoord0.xy);
	...
	// boost glow!
	s2half4 glow = tex2D(texture3, I.texcoord1.xy);
