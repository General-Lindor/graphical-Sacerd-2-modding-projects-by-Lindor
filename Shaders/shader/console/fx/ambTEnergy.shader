...
*/
	    ...
	    float4 out_color0 = float4(perlin_col.xyz * ob_col2.xyz + 0.5 * ob_col.xyz, tex0.a);
	    float4 out_color1 = float4(0.4 * perlin_col.xyz * ob_col2.xyz + 0.3 * ob_col.xyz,tex0.a);
	    ...
	    uniform float4      system_data)
    {
	    ...
	    // compose color & glow
	    O.col[0] = float4(perlin_col.xyz * ob_col2.xyz + 0.5 * ob_col.xyz, 1.0);
	    O.col[0].xyz *= tex0.a;
	    O.col[1] = float4(0.4 * perlin_col.xyz * ob_col2.xyz + 0.3 * ob_col.xyz, 1.0);
	    O.col[1].xyz *= tex0.a;
