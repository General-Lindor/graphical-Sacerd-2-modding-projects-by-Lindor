  ...
  )
{
	...
	float2 texcoord = I.texcoord0.xy + float2( param.y, 0);
	...
	s2half4 alpha = tex2D(texture2,-texcoord);
	...
	s2half4 bgr = tex2D(texture4, lerp(ofs_scr_pos.xy, ofs_scr_pos.zw, fader * alpha.a) );
