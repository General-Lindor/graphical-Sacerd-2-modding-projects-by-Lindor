               ...
               uniform float4   camera_pos)
{
  ...
  // vertex pos
    ...
    VSO.hposition = wvp_pos;
	  ...
	  VSO.ScreenCoordsInTexSpace.x   = VSO.hposition.w + screenPos.x;
	  VSO.ScreenCoordsInTexSpace.y   = VSO.hposition.w - screenPos.y;
	  VSO.ScreenCoordsInTexSpace.z   = VSO.hposition.z;
	  VSO.ScreenCoordsInTexSpace.w   = 2.0 * VSO.hposition.w; 
	  VSO.ScreenCoordsInTexSpace.xy *= target_data.xy;
