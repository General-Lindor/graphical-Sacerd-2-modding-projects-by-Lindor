    ...
    uniform float4      pix_data_array[2] )
{
  ...
  float4 race_color = pix_data_array[1];
...
/*	s2half4 tex1 = tex2D(texture1, I.texcoord0.xy);
	...
	O.col = intensity * (diffuse + specular + subsurface);
	O.col.a = tex0.a;*/
...
//	s2half3 nrm = normalize(tex2.xyz - s2half3(0.5, 0.5, 0.5));
  ...
  tex0.rgb += pix_data_array[1].rgb * tex3.a;
	...
	O.col[0] = intensity * (diffuse + specular + subsurface);
	O.col[0].a = tex0.a;
	O.col[1] = 0.5 * intensity * specular;
	O.col[1].a = tex0.a;
