...
#include "extractvalues.shader"
  ...
  struct appdata {
      ...
      uniform float4      light_col_diff)
    {
...
#ifdef XENON_IMPL
        float2 scr_pos =  tiling_data_half_tile.zw * vPos;
#else
        float2 scr_pos =  target_data.zw * vPos;
#endif
      ...
      s2half3 final_color = amb + specular + overlay;
      s2half3 final_glow  = 100.0 * overlay;
