  ...
  uniform float4    pix_data_array[2] )
{
  ...
  s2half3 glow_amb = tex1.a * tex0;
	...
	s2half4 out0 = s2half4(glow_amb + moon_diff + shadow.z * (diffuse + specular + subsurface), tex0.a);
	s2half4 out1 = s2half4(0.5 * shadow.z * specular + glow_amb, tex0.a);
